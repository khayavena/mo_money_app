...
import 'package:mo_money_app/features/login/bloc/get_profile_bloc.dart' as _i30;
...
import 'package:mo_money_app/features/transactions/repository/transaction_repository_impl.dart'
    as _i24;
import 'package:mo_money_app/http_delegate/http_req_delegate.dart' as _i9;
import 'package:mo_money_app/http_delegate/http_req_delegate_impl.dart' as _i10;
...
import 'package:mo_money_app/local_delegate/share_preferences/preferences_req_delegate_impl.dart'
    as _i8;
import 'package:mo_money_app/shared_components/util/NetworkHelper.dart' as _i11;
...
Future<_i1.GetIt> init(
  ...
  gh.factory<_i9.HttpReqDelegate>(
      () => _i10.HttpReqDelegateImpl(dioClient: gh<_i4.Dio>()));
  gh.factory<_i11.NetworkHelper>(() => _i12.NetworkHelperImpl());
  gh.factory<_i13.RemoteTransactionsService>(() =>
      _i14.RemoteTransactionsServiceImpl(
          httpReqDelegate: gh<_i9.HttpReqDelegate>()));
  gh.factory<_i15.RemoteMessagesService>(() => _i16.RemoteMessagesServiceImpl(
      httpReqDelegate: gh<_i9.HttpReqDelegate>()));
  ...
  gh.factory<_i19.LoginService>(() =>
      _i20.LoginServiceImpl(reqDelegate: gh<_i7.PreferencesReqDelegate>()));
  gh.factory<_i21.MessageService>(() =>
      _i22.MessageServiceImpl(reqDelegate: gh<_i5.AssetJsonReqDelegate>()));
  gh.factory<_i23.TransactionRepository>(() => _i24.TransactionRepositoryImpl(
        transactionService: gh<_i17.TransactionsService>(),
        remoteTransactionsService: gh<_i13.RemoteTransactionsService>(),
        networkHelper: gh<_i11.NetworkHelper>(),
      ));
  gh.factory<_i25.LoginRepository>(
      () => _i26.LoginRepositoryImpl(loginService: gh<_i19.LoginService>()));
  gh.factory<_i27.GetTransactionsBloc>(() =>
      _i27.GetTransactionsBloc(repository: gh<_i23.TransactionRepository>()));
  gh.factory<_i28.MessageRepository>(() => _i29.MessageRepositoryImpl(
        messageService: gh<_i21.MessageService>(),
        remoteMessagesService: gh<_i15.RemoteMessagesService>(),
        networkHelper: gh<_i11.NetworkHelper>(),
      ));
  gh.factory<_i30.GetProfileBloc>(
      () => _i30.GetProfileBloc(repository: gh<_i25.LoginRepository>()));
  gh.factory<_i31.GetLoginBloc>(
      () => _i31.GetLoginBloc(repository: gh<_i25.LoginRepository>()));
  gh.factory<_i32.GetMessagesBloc>(
      () => _i32.GetMessagesBloc(repository: gh<_i28.MessageRepository>()));
  return getIt;
}
